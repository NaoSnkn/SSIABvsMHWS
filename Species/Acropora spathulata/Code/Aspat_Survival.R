...
# If wanting to load the models later: brm2_models_DHW <- readRDS("Models/as_surv.brm2_list_DHW.rds")
...
as_surv.medians_ED50_DHW <- as_surv.medians_ED50_DHW |> 
  mutate(Genet = factor(Genet, levels=as_surv.medians_ED50_DHW |> pull(Genet)))
as_surv.medians_ED25_DHW <- as_surv.medians_ED25_DHW |> 
  mutate(Genet = factor(Genet, levels=as_surv.medians_ED50_DHW |> pull(Genet)))

### Plots ###

# Plot medians of ED50s
as_surv_ED50s_DHW <- as_surv.medians_ED50_DHW|>
...
as_surv_ED25s_DHW <- as_surv.medians_ED25_DHW|>
...
as_surv_EDs_medians_DHW <- as_surv_ED50s_DHW + as_surv_ED25s_DHW + 
